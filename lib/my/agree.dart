    ...
    Widget build(BuildContext context) {
      return Scaffold(
        appBar: AppBar(
          ...
          title: Text("隐私协议",style: TextStyle(fontSize: 18,color: Colors.black87),)
        ),
        body: Container(
