...
class FollowListState extends State<FollowList> {
  ...
  behavior: HitTestBehavior.opaque,
                                        onTap: () {
                                          Navigator.of(context,rootNavigator: true).push(
                                            ...
                                            return new VideoList(id:list[i]["category_id"], name:list[i]['subscription_name'].replaceAll("金十","期货"));
                                          }));
                                        },
                                        child: Container(
  ...
  behavior: HitTestBehavior.opaque,
                                        onTap: () {
                                          Navigator.of(context,rootNavigator: true).push(
                                            new MaterialPageRoute(builder: (BuildContext context) {
                                            return new VideoDetail(id:list[i]["video_list"][0]["id"]);
                                          }));
                                        },
                                        child: Container(
  ...
  behavior: HitTestBehavior.opaque,
                                        onTap: () {
                                          Navigator.of(context,rootNavigator: true).push(
                                            new MaterialPageRoute(builder: (BuildContext context) {
                                            return new VideoDetail(id:list[i]["video_list"][1]["id"]);
                                          }));
                                        },
                                        child: Container(
                                            margin: EdgeInsets.all(10),
