...
import 'package:futures/report.dart';
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  new CircleAvatar(
                    radius: 15.0,
                    backgroundImage:val["avatar"] != null ?  NetworkImage(val["avatar"]) : (image != null ? MemoryImage(image)  : AssetImage('assets/default_nor_avatar.png')),
                  ),
                  Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      Row(
                        children: <Widget>[
                          Image(
                            image: AssetImage('assets/video_hot.jpg'),
                            height: 10,
                            width: 8,
                            fit: BoxFit.fill,
                          ),
