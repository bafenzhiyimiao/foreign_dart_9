...
class VideoScreenState extends State<VideoScreen> {
  ...
  var sliderList = [
    {
      ...
      "display_datetime": "2020-01-03 14:50:30",
      "detail_img": "https://cdn-news.jin10.com/6238d7be-27bd-40e6-94e6-776b5a4dfe53.jpg",
      "id": 11218,
    },{
      "title": "特斯拉股价全解析 5年内涨至7000美元？",
      "display_datetime": "2020-02-18 17:52:20",
      "detail_img": "https://cdn-news.jin10.com/004e7245-1555-4c66-a3ec-5aa7b76c2c0c.png",
      "id": 11360,
    }, {
				"title": "强东吞下1号店    马云后悔创阿里",
				"display_datetime": "2016-07-02 02:26:13",
				"detail_img": "https://cdn.jin10.com/video/pic/15231a8a085575e91e33696c4cd1b104.jpg",
				"id": 1175,
			},
  ];
                                  ...
                                  child: Swiper(
                                    ...
                                    onTap: (index){
                                      Navigator.of(context,rootNavigator: true).push(
                                        ...
                                        return new VideoDetail(id:sliderList[index]["id"]);
                                      }));
                                    },
                                  ),
                                ) : Container(height: 0,),
  ...
  behavior: HitTestBehavior.opaque,
                                        onTap: () {
                                          Navigator.of(context,rootNavigator: true).push(
                                            new MaterialPageRoute(builder: (BuildContext context) {
                                            return new VideoList(id:list[i]["category_id"], name:list[i]['name'].replaceAll("金十","期货"));
                                          }));
                                        },
                                        child: Container(
  ...
  behavior: HitTestBehavior.opaque,
                                        onTap: () {
                                          Navigator.of(context,rootNavigator: true).push(
                                            new MaterialPageRoute(builder: (BuildContext context) {
                                            return new VideoDetail(id:list[i]["list"][0]["id"]);
                                          }));
                                        },
                                        child: Container(
  ...
  behavior: HitTestBehavior.opaque,
                                        onTap: () {
                                          Navigator.of(context,rootNavigator: true).push(
                                            new MaterialPageRoute(builder: (BuildContext context) {
                                            return new VideoDetail(id:list[i]["list"][1]["id"]);
                                          }));
                                        },
                                        child: Container(
                                            margin: EdgeInsets.all(10),
